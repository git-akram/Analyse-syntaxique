...
\begin{figure}[h]
	\centering
		\includegraphics[width=1.0\textwidth]{DiagrammeFluxXtext.png}
...
\begin{figure}[h]
	\centering
		\includegraphics[width=1.0\textwidth,height=10cm]{1.PNG}
	\label{fig:1}
\end{figure}\FloatBarrier

Tout d'abord on va créer un projet Xtext avec comme nom et extension demo.
...
\begin{figure}[h]
	\centering
		\includegraphics[width=1.0\textwidth,height=10cm]{2.PNG}
	\label{fig:2}
\end{figure}\FloatBarrier

Ici on va definir notre langage dans le fichier .xtetx avec une grammaire proche de celle de Antlr.
...
\begin{figure}[h]
	\centering
		\includegraphics[width=1.0\textwidth,height=10cm]{3.PNG}
	\label{fig:3}
\end{figure}
...
Apres la generation,les projets se sont remplis,et j'ai certain services qui sont proposés :formatteur,generateur, validateur...
 ...
 \subsubsubsection{Etape 3:Faire un test}


\begin{figure}[h]
	\centering
		\includegraphics[width=1.0\textwidth,height=10cm]{4.PNG}
	\label{fig:4}
\end{figure}
...
En utilisant le contet assist(ctrl+espace) pour la premiere fois,le mot category est généré,vu qu'il connait la grammaire et il sait que par default ça commence par une categorie,apres on aura le hoix ou bien d'ecrire ue autre categorie ou commencer une expression.


\subsubsubsection{Etape 5:Ajouter une validation}


\begin{figure}[h]
	\centering
		\includegraphics[width=1.0\textwidth,height=10cm]{5.PNG}
	\label{fig:5}
\end{figure}
