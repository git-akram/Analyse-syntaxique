...
La différence majeure entre Yacc et Antler est que Yacc génére des analyseurs syntaxiques de type LALR, alors que ceux générés par ANTLR sont de type LL. C’est une différence pour plusieurs application, par exemple :
